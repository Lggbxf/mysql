...
/*	fprintf(cgiOut, "<head><meta charset=\"utf-8\"/><title>查询结果</title>\
	...
	if (sno[0] == '*')
	{
		sprintf(sql, "select information.sno,information.name,information.deptno,school.dept,score.class,score.score,score.flag from information,score,school where information.deptno=school.deptno and information.sno=score.sno and score.flag=0");
	}
	else
	{
		sprintf(sql, "select information.sno,information.name,information.deptno,school.dept,score.class,score.score,score.flag from information,score,school where information.deptno=school.deptno and information.sno=score.sno and score.flag=0 and information.sno=%d", atoi(sno));
	}
