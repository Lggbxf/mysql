...
/*	fprintf(cgiOut, "<head><meta charset=\"utf-8\"/><title>查询结果</title>\
	...
	if (name[0] == '*')
	{
		sprintf(sql,"select information.sno,information.name,information.sex,information.deptno,school.schoolname,school.dept,information.flag from information,school where information.deptno=school.deptno and information.flag=0");
	}
	else
	{
		sprintf(sql, "select information.sno,information.name,information.sex,information.deptno,school.schoolname,school.dept,information.flag from information,school where name = '%s' and information.deptno=school.deptno and information.flag=0 ", name);
	}
